...
<div class="card">
  <h2>Presets &mdash; c4: kappa 2, COM 1.05 &mdash; GRID-6 cap-only sweep champions (cap 354, kappa PID torso, no lag / no FF), robust + clearance filtered</h2>
  <div class="row">
    <button class="mini" id="g-1" onclick="pick('1')">1 &middot; mu 0.12 ice (PID)<br>
      <small>1.65/290/95/32/25 &mdash; sim 0.37 m/s, crank 492 OVER</small></button>
    ...
    <button class="mini" id="g-2" onclick="pick('2')">2 &middot; mu 0.45 floor (PID)<br>
      <small>1.65/260/130/32/40 &mdash; sim 0.47 m/s, crank 674 OVER</small></button>
  </div>
</div>
