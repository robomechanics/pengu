...
<div class="card">
  <h2>Presets &mdash; c5: kappa 2, COM 1.20 &mdash; GRID-6 hardware-sweep champions (cap 354, 56 ms, feedforward torso), robust + clearance filtered</h2>
  <div class="row">
    <button class="mini" id="g-1" onclick="pick('1')">1 &middot; mu 0.12 ice<br>
      <small>1.65/230/130/32/25 &mdash; ff 24.2/242, sim 0.43 m/s, crank 674 OVER</small></button>
    ...
    <button class="mini" id="g-2" onclick="pick('2')">2 &middot; mu 0.45 floor<br>
      <small>1.50/290/90/24/25 &mdash; ff 17.6/218, sim 0.41 m/s, crank 424 OVER</small></button>
  </div>
</div>
