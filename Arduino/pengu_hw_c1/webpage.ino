...
<div class="card">
  <h2>Presets &mdash; c1: kappa 0, COM 1.05 &mdash; GRID-6 hardware-sweep champions (cap 354, 56 ms, feedforward torso), robust + clearance filtered</h2>
  <div class="row">
    <button class="mini" id="g-1" onclick="pick('1')">1 &middot; mu 0.12 ice<br>
      <small>1.55/260/125/28/25 &mdash; ff 17.8/165, sim 0.28 m/s, crank 609 OVER</small></button>
    ...
    <button class="mini" id="g-2" onclick="pick('2')">2 &middot; mu 0.45 floor<br>
      <small>1.65/30/80/32/40 &mdash; ff 37.8/140, sim 0.59 m/s, crank 415 OVER</small></button>
  </div>
</div>
