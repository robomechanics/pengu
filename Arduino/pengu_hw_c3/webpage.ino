...
<div class="card">
  <h2>Presets &mdash; c3: kappa 0, COM 1.31 &mdash; GRID-6 cap-only sweep champions (cap 354, kappa PID torso, no lag / no FF), robust + clearance filtered</h2>
  <div class="row">
    <button class="mini" id="g-1" onclick="pick('1')">1 &middot; mu 0.12 ice (PID)<br>
      <small>1.25/280/125/24/20 &mdash; sim 0.14 m/s, crank 491 OVER</small></button>
    <button class="mini" id="g-3" onclick="pick('3')">3 &middot; torso calib<br>
      <small>1.39/240/80/16/30 &mdash; the bout that never fell (kappa 0, FF)</small></button>
    <button class="mini" id="g-2" onclick="pick('2')">2 &middot; mu 0.45 floor (PID)<br>
      <small>1.65/310/130/20/20 &mdash; sim 0.25 m/s, crank 674 OVER</small></button>
  </div>
</div>
