...
<div class="card">
  <h2>Presets &mdash; c2: kappa 0, COM 1.20 &mdash; GRID-6 hardware-sweep champions (cap 354, 56 ms, feedforward torso), robust + clearance filtered</h2>
  <div class="row">
    <button class="mini" id="g-1" onclick="pick('1')">1 &middot; mu 0.12 ice<br>
      <small>1.50/300/100/32/20 &mdash; ff 23.0/78, sim 0.49 m/s, crank 471 OVER</small></button>
    ...
    <button class="mini" id="g-2" onclick="pick('2')">2 &middot; mu 0.45 floor<br>
      <small>1.65/270/100/24/30 &mdash; ff 19.3/50, sim 0.45 m/s, crank 518 OVER</small></button>
  </div>
</div>
